...
public class Const {
    ...
    public static final int MEDIA_VIDEO_REQUEST_CODE = 1011;
    public static final int FOLDER_PICKER_REQUEST_CODE = 1012;
    ...
    public static final String RECORDING_STATE_CHANGED = "com.orpheusdroid.screenrecorder.RECORDING_STATE_CHANGED";
    public static final String RECORDING_STATE_EXTRA = "recording_state";
    ...
    public static final String SAVE_LOCATION_URI_KEY = "savelocation_uri";
